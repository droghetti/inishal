# Django settings for inishal project.
import os
...
SECRET_KEY = 'fht4-%buk$b*$l@s5axd5q28n&+po%f@ove6g2_)4@uo4zd+#2'
...
ROOT_URLCONF = 'inishal.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'inishal.wsgi.application'
